  ...
  return (
    <header className={cn(
      ...
      <div className="container mx-auto flex h-14 items-center justify-between">
        {/* Logo du site */}
        <div className="flex-shrink-0 flex items-center w-[150px]">
          <Link href="/" className="flex items-center relative group">
            ...
            <Image
              ...
              priority
              unoptimized
              className="object-contain relative z-10 h-auto w-auto max-h-[32px]"
              style={{ maxWidth: '90px' }}
            />
          </Link>
        </div>

        {/* Navigation principale - centrage amélioré */}
        <div className="hidden md:flex flex-1 justify-center">
          <nav className="flex items-center space-x-2">
            ...
            <Link 
              ...
              className={cn(
                "navbar-link",
                pathname === "/rankings" && "bg-primary/20"
              )}
            >
          ...
          <nav className="flex flex-col space-y-2 p-4">
            ...
            <Link href="/rankings" onClick={() => setIsMobileMenuOpen(false)}>
              <Button 
                ...
                className={cn(
                  "w-full justify-start gap-2",
                  pathname === "/rankings" && "bg-primary/10"
                )}
              >
